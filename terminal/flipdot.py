'''
 From: https://github.com/vwyf/vwyf_door_sensor/blob/2a281e274d4d14e7d020158d55fd5dc94bfccd13/flipdot_demon.py
 flipdot display
...
def show_slice(panel_address, t, srl, display_string):
    transmission = bytearray([
        0x80,  # header
        0x83,  # 28 bytes, refresh
    ...
    for i in range(t, t + 28):  # 28 bytes data
        transmission.append(display_string[i % len(display_string)])
